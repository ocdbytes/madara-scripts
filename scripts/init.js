...
const ETHEREUM_PRIVATE_KEY =
  "04dd8105975c7fa1b18cc399ead77e9c0bebe76be03bab2de7dd88bf1e7b2a61";
const eth_provider = new ethers.JsonRpcProvider(
  "https://sepolia.infura.io/v3/bf9e41563a6a45e28eb60382d85ef3c9"
);
const wallet = new ethers.Wallet(ETHEREUM_PRIVATE_KEY, eth_provider);

const starknet_provider = new starknet.RpcProvider({
  nodeUrl: "https://madara-prakhar-testing-dev.karnot.xyz",
});
...
async function main() {
  ...
  const l1_bridge_address = "0x00cd0f644c4c2e23c8332e6cedcf3002b5ae0ad9";
  const core_contract_address = "0xdf2630b986620ffcd790cfc60c2689587593fa5d";
  const l2_eth_token_address =
    "0x49d36570d4e46f48e99674bd3fcc84644ddd6b96f7c741b1562b82f9e004dc7";
  const l2_eth_bridge_address =
  ...
  await overrideStateOnCoreContract(6261 - 1, core_contract_address);

  await setupMongoDb(6261 - 1);
}
